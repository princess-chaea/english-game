...
if (!secureAccount.includes('window.innerWidth/1600') || !secureAccount.includes('grid-template-columns:repeat(5,minmax(0,1fr))') || !secureAccount.includes('--teacher-design-height')) throw new Error('Teacher landscape must keep the desktop workspace and scale it to the viewport.');
