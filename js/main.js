        ...
        function attemptWorldBossRichSkillUnlock(skill) {
            ...
            if (quizType === 'meaning-choice') {
                ...
                const meaningHint = document.createElement('p');
                meaningHint.className = 'mt-3 border border-purple-800/70 bg-purple-950/25 px-3 py-2 text-center text-sm font-black text-purple-100';
                meaningHint.textContent = `뜻: ${String(skill.meaning || '뜻 정보 없음')}`;
